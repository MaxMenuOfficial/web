...
<div class="section">
  <div class="section-inner">
    ...
    <div class="op-fallback-card">
      ...
      <p>
        El menú de MaxMenu (sin pagos) funciona en cualquier país del mundo. Si tu país no aparece arriba,
        puedes usar MaxMenu como menú digital completo — con personalización, alérgenos, traducciones y widget embebible —
        pero sin la funcionalidad de Order &amp; Pay. Estamos trabajando para ampliar la cobertura.
      </p>
    </div>
