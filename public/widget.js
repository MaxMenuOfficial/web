(async () => {
  ...
  // 🔹 Ahora siempre desde tu dominio protegido
  ...
  try {
    ...
    script.src = widgetUrl; // 🔹 ya sin ?_=Date.now()
    script.async = false;
    ...
    originalContainer.innerHTML = '<p style="color:red;">[MaxMenu] No se pudo cargar el menú.</p>';
  }
})();